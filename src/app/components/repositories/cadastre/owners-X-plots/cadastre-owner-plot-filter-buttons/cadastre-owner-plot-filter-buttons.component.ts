...
@Component({
  selector: 'app-cadastre-owner-plot-filter-buttons',
  standalone: true,
  imports: [],
  templateUrl: './cadastre-owner-plot-filter-buttons.component.html',
  styleUrl: './cadastre-owner-plot-filter-buttons.component.css'
})
export class CadastreOwnerPlotFilterButtonsComponent<T extends Record<string, any>> {
   ...
   */
  exportToPdf() {
    this.ownerPlotService.giveAllOwnersByPlot(this.ownerId, 0, this.LIMIT_32BITS_MAX).subscribe(
      response => {
